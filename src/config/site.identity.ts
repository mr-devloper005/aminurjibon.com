export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'aminurjibon',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Aminurjibon',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'aminurjibon.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://aminurjibon.com',
